...
Çalışan bölümün glossary ve çoğu ayarı checkpoint'e sabitlenir. Ayar veya glossary değişikliği bir sonraki bölümden itibaren uygulanır. Bitiş işareti denetimi, işaretsiz sınır ve otomatik tekrar sayısı yarım bölüm yeniden sürdürüldüğünde güncel ayarlardan alınır. Tamamlanmamış bölümün kaynak, prompt veya glossary değerini elle değiştirmek güvenlik hatası oluşturur.
